    ...
    >
      <main className="max-w-7xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 xl:col-span-4 sticky top-10 space-y-8 animate-in fade-in slide-in-from-left-4 duration-700">
        ...
        <section className="mt-32 pt-16 border-t border-gray-100">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
             <div className="max-w-2xl">
                <h2 className="text-3xl font-black tracking-tight mb-4 text-gray-900">Latent Manifold Map</h2>
                <p className="text-gray-500 leading-relaxed">
                  Interactive visualization of the material feature space. Each point represents a unique crystal structure generated or trained on by the model. 
                  Clustering reveals property correlations.
                </p>
             </div>
             <div className="hidden md:block">
                 <div className="flex items-center gap-2 text-xs font-mono text-gray-400">
                    <span className="block w-2 h-2 rounded-full bg-indigo-500"></span> Stable
                    <span className="block w-2 h-2 rounded-full bg-pink-500 ml-2"></span> Unstable
                 </div>
             </div>
          </div>
          <div className="rounded-3xl overflow-hidden shadow-2xl shadow-gray-200/50 border border-gray-200">
              <EmbeddingMap height={700} />
          </div>
        </section>
      </main>
    </motion.div>
